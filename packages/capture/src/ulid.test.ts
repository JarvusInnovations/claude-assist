...
describe('ulidFromSeed', () => {
  it('is deterministic for the same time + seed', () => {
    const a = ulidFromSeed(1720000000123, 'slack:C123:1720000000.000100');
    const b = ulidFromSeed(1720000000123, 'slack:C123:1720000000.000100');
    expect(a).toBe(b);
  ...
  it('differs when the seed differs', () => {
    const a = ulidFromSeed(1720000000123, 'slack:C123:1720000000.000100');
    const b = ulidFromSeed(1720000000123, 'slack:C123:1720000000.000200');
    expect(a).not.toBe(b);
  });
});
