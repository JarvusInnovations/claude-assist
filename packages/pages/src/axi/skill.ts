 ...
 * skills/assist-pages/SKILL.md. The narrative guidance in SKILL.md is
 ...
 * (`scripts/pages-axi`), since the skill may be installed without the binary
 * on PATH.
 */

const SKILL_INVOCATION = "scripts/pages-axi";
