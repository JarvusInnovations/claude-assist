...
2. Estimate total calories and macros (protein_g, fat_g, sat_fat_g, carbs_g, sodium_mg) for the portion you can see/read — not a "standard serving" from a database, your own best visual/textual judgement.
3. Give a short display label (under 60 chars) — e.g. "Grilled chicken salad", "Two slices pepperoni pizza".
4. State your portion basis in one short phrase (e.g. "one dinner plate, ~350g", "12oz based on the note").
5. State confidence 0.0-1.0. Lower confidence for ambiguous photos, no photos (note-only), or unusual foods.
6. If there is truly nothing to go on (no photo, no note, or unreadable), still return your best guess with low confidence — never refuse. A rough number beats no number.
</instructions>
