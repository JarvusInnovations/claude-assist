 ...
 * skills/assist-kitchen/SKILL.md. The narrative guidance in SKILL.md is
 ...
 * (`scripts/kitchen-axi`), since the skill may be installed without the binary
 * on PATH.
 */

const SKILL_INVOCATION = "scripts/kitchen-axi";
